...
/** The one it opens on. Rex is the gravel voice; a manager who says "lock in"
 *  unironically wants the bright one, so it starts on zenith instead. */
export const DEFAULT_VOICE = 'zenith';
